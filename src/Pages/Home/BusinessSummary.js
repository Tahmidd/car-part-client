...
const BusinessSummary = () => {
    return (
        <div className='my-20'>
            <div>
                <h2 className='text-center my-10 text-3xl font-bold text-secondary'>Business Summary</h2>
            </div>
            <div className="stats shadow flex justify-center bg-gradient-to-r from-secondary to-primary text-white">
                <div className="stat">
